...
const UploadFile = () => {
    ...
    return (
        <div className='flex flex-col justify-center items-center gap-5'>
            <form onSubmit={uploadImage} className="file-upload-form flex-col my-10">
                <label htmlFor="file" className="file-upload-label flex flex-col">
                    ...
                    <input id="file" accept='image/*' type="file" onChange={handleImageChange} />
                </label>
            ...
            <div className="flex flex-col w-full justify-center">
                {imagePreview && (
                    <img className="w-72" src={imagePreview} alt="image-cv" />
                )}
            </div>
        </div>
    );
